...
public class CustomRangeWeekView extends RangeWeekView {
    ...
    @Override
    protected boolean onDrawSelected(Canvas canvas, CalendarviewCalendar calendar, int x, boolean hasScheme,
    ...
    @Override
    protected void onDrawScheme(Canvas canvas, CalendarviewCalendar calendar, int x, boolean isSelected) {
        int cx = x + mItemWidth / 2;
        int cy = mItemHeight / 2;
    ...
    @Override
    protected void onDrawText(Canvas canvas, CalendarviewCalendar calendar, int x, boolean hasScheme, boolean isSelected) {
