...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
     ...
     * 被选择的中间日期背景色
     */
    protected Paint mSelectedMidPaint = new Paint();
     ...
     * 日历项
     */
    List<CalendarviewCalendar> mItems;
    ...
    private void initPaint(Context context) {
        ...
        mOtherMonthTextPaint.setColor(0xFFA4A5A8);
        ...
        mSchemeTextPaint.setColor(0xff3f52e7);
        ...
        mSelectTextPaint.setColor(0xff3f52e7);
        ...
        mCurDayTextPaint.setColor(0xffefefef);
        ...
        mCurDayLunarTextPaint.setColor(0xffefefef);
        ...
        mSelectedMidPaint.setAntiAlias(true);
        mSelectedMidPaint.setStyle(Paint.Style.FILL);
        mSelectedMidPaint.setStrokeWidth(2);
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        this.mSelectedPaint.setColor(0xFF3F52E7);
        this.mSelectedMidPaint.setStyle(Paint.Style.FILL);
        this.mSelectedMidPaint.setColor(0xFF6F7FFD);
    ...
    final void addSchemesFromMap() {
        ...
        for (CalendarviewCalendar a : mItems) {
            if (mDelegate.mSchemeDatesMap.containsKey(a.toString())) {
                CalendarviewCalendar d = mDelegate.mSchemeDatesMap.get(a.toString());
     ...
     */
    protected boolean isSelected(CalendarviewCalendar calendarviewCalendar) {
        return mItems != null && mItems.indexOf(calendarviewCalendar) == mCurrentItem;
    }
     ...
     * @return 是否拦截日期
     */
    protected final boolean onCalendarIntercept(CalendarviewCalendar calendarviewCalendar) {
