...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        mDelegate.mInnerListener = new OnInnerDateSelectedListener() {
             ...
             */
            @Override
            public void onMonthDateSelected(CalendarviewCalendar calendarviewCalendar, boolean isClick) {

                if (calendarviewCalendar.getYear() == mDelegate.getCurrentDay().getYear() &&
                        calendarviewCalendar.getMonth() == mDelegate.getCurrentDay().getMonth()
                ...
                if (mWeekBar != null &&
                    ...
                    mWeekBar.onDateSelected(calendarviewCalendar, mDelegate.getWeekStart(), isClick);
                }
            }
             ...
             */
            @Override
            public void onWeekDateSelected(CalendarviewCalendar calendarviewCalendar, boolean isClick) {
                mDelegate.mIndexCalendarviewCalendar = calendarviewCalendar;
                if (mDelegate.getSelectMode() == CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick
                        || mDelegate.mIndexCalendarviewCalendar.equals(mDelegate.mSelectedCalendarviewCalendar)) {
                    mDelegate.mSelectedCalendarviewCalendar = calendarviewCalendar;
                }
                int y = calendarviewCalendar.getYear() - mDelegate.getMinYear();
                int position = 12 * y + mDelegate.mIndexCalendarviewCalendar.getMonth() - mDelegate.getMinYearMonth();
        ...
        if (isInRange(mDelegate.getCurrentDay())) {
            mDelegate.mSelectedCalendarviewCalendar = mDelegate.createCurrentDate();
        } else {
            mDelegate.mSelectedCalendarviewCalendar = mDelegate.getMinRangeCalendar();
        }
    ...
    public void setRange(int minYear, int minYearMonth, int minYearDay,
        ...
        if (!isInRange(mDelegate.mSelectedCalendarviewCalendar)) {
            mDelegate.mSelectedCalendarviewCalendar = mDelegate.getMinRangeCalendar();
    ...
    public void closeYearSelectLayout() {
        ...
        int position = 12 * (mDelegate.mSelectedCalendarviewCalendar.getYear() - mDelegate.getMinYear()) +
                mDelegate.mSelectedCalendarviewCalendar.getMonth() - mDelegate.getMinYearMonth();
        closeSelectLayout(position);
        mDelegate.isShowYearSelectedLayout = false;
    }
    ...
    public void scrollToCurrent(boolean smoothScroll) {
        ...
        CalendarviewCalendar calendarviewCalendar = mDelegate.createCurrentDate();
        if (mDelegate.mCalendarInterceptListener != null &&
                mDelegate.mCalendarInterceptListener.onCalendarIntercept(calendarviewCalendar)) {
            mDelegate.mCalendarInterceptListener.onCalendarInterceptClick(calendarviewCalendar, false);
            return;
        }
        mDelegate.mSelectedCalendarviewCalendar = mDelegate.createCurrentDate();
        mDelegate.mIndexCalendarviewCalendar = mDelegate.mSelectedCalendarviewCalendar;
    ...
    public void scrollToSelectCalendar() {
        if (!mDelegate.mSelectedCalendarviewCalendar.isAvailable()) {
            return;
        }
        scrollToCalendar(mDelegate.mSelectedCalendarviewCalendar.getYear(),
                mDelegate.mSelectedCalendarviewCalendar.getMonth(),
                mDelegate.mSelectedCalendarviewCalendar.getDay(),
                false);
    }
     ...
     * @return return_back2
     */
    public final List<CalendarviewCalendar> getSelectCalendarRange() {
    ...
    public final void setOnCalendarInterceptListener(OnCalendarInterceptListener listener) {
        ...
        if (!listener.onCalendarIntercept(mDelegate.mSelectedCalendarviewCalendar)) {
            return;
        }
        mDelegate.mSelectedCalendarviewCalendar = new CalendarviewCalendar();
    }
    ...
    public void setOnMonthChangeListener(OnMonthChangeListener listener) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                mDelegate.mMonthChangeListener.onMonthChange(mDelegate.mSelectedCalendarviewCalendar.getYear(),
                        mDelegate.mSelectedCalendarviewCalendar.getMonth());
            }
        });
    }
     ...
     */
    public final void setSchemeDate(Map<String, CalendarviewCalendar> mSchemeDates) {
     ...
     * @param calendarviewCalendar calendarviewCalendar
     */
    public final void removeSchemeDate(CalendarviewCalendar calendarviewCalendar) {
        ...
        if (mDelegate.mSchemeDatesMap.containsKey(calendarviewCalendar.toString())) {
            mDelegate.mSchemeDatesMap.remove(calendarviewCalendar.toString());
        }
        if (mDelegate.mSelectedCalendarviewCalendar.equals(calendarviewCalendar)) {
    ...
    public final void setSelectDefaultMode() {
        ...
        mDelegate.mSelectedCalendarviewCalendar = mDelegate.mIndexCalendarviewCalendar;
    ...
    private void setWeekStart(int weekStart) {
        ...
        mWeekBar.onDateSelected(mDelegate.mSelectedCalendarviewCalendar, weekStart, false);
     ...
     * @return 获取当前周数据
     */
    public List<CalendarviewCalendar> getCurrentWeekCalendars() {
     ...
     * @return 获取选择的日期
     */
    public CalendarviewCalendar getSelectedCalendar() {
        return mDelegate.mSelectedCalendarviewCalendar;
    }
     ...
     * @return 最小范围日期
     */
    public CalendarviewCalendar getMinRangeCalendar() {
     ...
     * @return 最大范围日期
     */
    public CalendarviewCalendar getMaxRangeCalendar() {
     ...
     * @return 是否在日期范围内
     */
    protected final boolean isInRange(CalendarviewCalendar calendarviewCalendar) {
        return mDelegate != null && CalendarUtil.isCalendarInRange(calendarviewCalendar, mDelegate);
    }
    ...
    public interface OnWeekChangeListener {
        void onWeekChange(List<CalendarviewCalendar> weekCalendarviewCalendars);
    }
    ...
    interface OnInnerDateSelectedListener {
         ...
         * @param isClick  是否是点击
         */
        void onMonthDateSelected(CalendarviewCalendar calendarviewCalendar, boolean isClick);
         ...
         * @param isClick  是否是点击
         */
        void onWeekDateSelected(CalendarviewCalendar calendarviewCalendar, boolean isClick);
    }
    ...
    public interface OnCalendarRangeSelectListener {
         ...
         * @param calendarviewCalendar calendarviewCalendar
         */
        void onCalendarSelectOutOfRange(CalendarviewCalendar calendarviewCalendar);
         ...
         */
        void onSelectOutOfRange(CalendarviewCalendar calendarviewCalendar, boolean isOutOfMinRange);
         ...
         * @param isEnd    是否结束
         */
        void onCalendarRangeSelect(CalendarviewCalendar calendarviewCalendar, boolean isEnd);
    }
    ...
    public interface OnCalendarSelectListener {
         ...
         * @param calendarviewCalendar calendarviewCalendar
         */
        void onCalendarOutOfRange(CalendarviewCalendar calendarviewCalendar);
         ...
         */
        void onCalendarSelect(CalendarviewCalendar calendarviewCalendar, boolean isClick);
    }
    ...
    public interface OnCalendarLongClickListener {
         ...
         * @param calendarviewCalendar calendarviewCalendar
         */
        void onCalendarLongClickOutOfRange(CalendarviewCalendar calendarviewCalendar);
         ...
         * @param calendarviewCalendar calendarviewCalendar
         */
        void onCalendarLongClick(CalendarviewCalendar calendarviewCalendar);
    }
    ...
    public interface OnCalendarInterceptListener {
        boolean onCalendarIntercept(CalendarviewCalendar calendarviewCalendar);

        void onCalendarInterceptClick(CalendarviewCalendar calendarviewCalendar, boolean isClick);
    }
}
