...
public final class CalendarviewCalendar implements Serializable {
     ...
     * 获取完整的农历日期
     */
    private CalendarviewCalendar lunarCalendarviewCalendar;
    ...
    public CalendarviewCalendar getLunarCalendarviewCalendar() {
        return lunarCalendarviewCalendar;
    }

    public void setLunarCalendarviewCalendar(CalendarviewCalendar lunarCakendar) {
        this.lunarCalendarviewCalendar = lunarCakendar;
    }
     ...
     * 是否是相同月份
     *
     * @param calendarviewCalendar 日期
     * @return 是否是相同月份
     */
    public boolean isSameMonth(CalendarviewCalendar calendarviewCalendar) {
        return year == calendarviewCalendar.getYear() && month == calendarviewCalendar.getMonth();
    }
     ...
     * @return -1 0 1
     */
    public int compareTo(CalendarviewCalendar calendarviewCalendar) {
        if (calendarviewCalendar == null) {
            return 1;
        }
        return toString().compareTo(calendarviewCalendar.toString());
    }
     ...
     * @return 运算差距多少天
     */
    public final int differ(CalendarviewCalendar calendarviewCalendar) {
        return CalendarUtil.differ(this, calendarviewCalendar);
    }
    ...
    public boolean equals(Object o) {
        if (o != null && o instanceof CalendarviewCalendar) {
            if (((CalendarviewCalendar) o).getYear() == year && ((CalendarviewCalendar) o).getMonth() == month && ((CalendarviewCalendar) o).getDay() == day)
                return true;
        }
    ...
    final void mergeScheme(CalendarviewCalendar calendarviewCalendar, String defaultScheme) {
        if (calendarviewCalendar == null)
            return;
        setScheme(TextUtils.isEmpty(calendarviewCalendar.getScheme()) ?
                defaultScheme : calendarviewCalendar.getScheme());
        setSchemeColor(calendarviewCalendar.getSchemeColor());
        setSchemes(calendarviewCalendar.getSchemes());
    }
