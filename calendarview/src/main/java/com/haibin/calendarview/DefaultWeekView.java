    ...
    protected void onDrawText(Canvas canvas, CalendarviewCalendar calendarviewCalendar, int x, boolean hasScheme, boolean isSelected) {
        ...
        if (isSelected) {
            canvas.drawText(String.valueOf(calendarviewCalendar.getDay()), cx, mTextBaseLine + top,
                    mSelectTextPaint);
            canvas.drawText(calendarviewCalendar.getLunar(), cx, mTextBaseLine + mItemHeight / 10, mSelectedLunarTextPaint);
        } else if (hasScheme) {
            canvas.drawText(String.valueOf(calendarviewCalendar.getDay()), cx, mTextBaseLine + top,
            ...
            canvas.drawText(calendarviewCalendar.getLunar(), cx, mTextBaseLine + mItemHeight / 10,
