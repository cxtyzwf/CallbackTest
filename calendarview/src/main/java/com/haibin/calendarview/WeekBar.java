...
public class WeekBar extends LinearLayout {
     ...
     *
     * @param calendarviewCalendar  calendarviewCalendar 选择的日期
     * @param weekStart 周起始
     * @param isClick   isClick 点击
     */
    protected void onDateSelected(CalendarviewCalendar calendarviewCalendar, int weekStart, boolean isClick) {
     ...
     */
    protected int getViewIndexByCalendar(CalendarviewCalendar calendarviewCalendar, int weekStart) {
        int week = calendarviewCalendar.getWeek() + 1;
